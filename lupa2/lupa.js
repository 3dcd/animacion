...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("AzYaVMAAAg0pMAmxAAAMAAAA0pg");
	mask.setTransform(905.9,455.875);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("Ay6QgMAAAgg/MAl1AAAMAAAAg/g");
	mask.setTransform(906.95,734.05);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"Mapadebits4.png", id:"Mapadebits4"},
		{src:"Mapadebits5.png", id:"Mapadebits5"}
	],
	preloads: []
};
